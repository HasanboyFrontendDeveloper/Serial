...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../server/server */ "./src/server/server.js");
...
function form(formSelector, modelTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      (0,_server_server__WEBPACK_IMPORTED_MODULE_10__.postData)('http://localhost:3000/request', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)('.modal', modelTimerId);
...
function modal(triggerSelector, modalSelector, modelTimerId) {
  ...
  modalTrigger.forEach(function (item) {
    item.addEventListener('click', function () {
      return openModal(modalSelector, modelTimerId);
    });
  });
...
window.document.addEventListener('DOMContentLoaded', function () {
  var modelTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modelTimerId);
  }, 5000);
  (0,_modules_class__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])('form', modelTimerId);
  (0,_modules_loader__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-modal]', '.modal', modelTimerId);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-11-01');
});
})();
